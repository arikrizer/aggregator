...
KEYWORDS = [
    "Hybrid Intelligence organizations",
    "Augmented Organizational Behavior AI",
    "Human-AI Teaming workplace",
    "Organizational Design AI 2024 2025",
    "Future of Management AI",
    "Corporate AI Ethics organizational",
]

SYSTEM_PROMPT = """You are a strategic research analyst specializing in Human-AI Augmentation in Organizations.
...
def run():
    ...
    print("🧠 האסטרטג — מסנן ומנתח עם Groq...")

    # Process in chunks of 8 to avoid token limits
    chunk_size = 8
    all_items = []
    ...
    for i in range(0, len(unique_results), chunk_size):
        ...
        try:
            ...
            # Handle both {"items": [...]} and direct array wrapped in object
    ...
    print(f"  ✅ האסטרטג החזיר {len(all_items)} פריטים סה\"כ")
    return all_items
